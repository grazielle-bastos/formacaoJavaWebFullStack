...
public class ClasseJava {
	...
	public static void main(String[] args) {
		 ...
		 * Não é boa prática acessar diretamente os atributos do objeto público, deve ser privado pra evitar erros por chamadas indevidas, e nesse caso devemos aplicar os métodos getters e setters no objeto:
		 * aluno1.nome = "João"; aluno1.idade = 50;
		 * 
